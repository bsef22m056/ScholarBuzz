...
export interface Scholarship {
  ...
  eligibility: {
    ruleBased: Record<
      string,
      { required: string | number; met: boolean; userValue: string | number }
    >;
...
const mockScholarships: Scholarship[] = [
    ...
    eligibility: {
      ruleBased: {
        ...
        degreeLevel: {
          ...
          met: true,
          userValue: "Bachelor's",
        },
      },
      aiBased: {
        fieldMatch: {
          score: 92,
          reason: "Computer Science matches STEM requirement",
        },
        skillsMatch: {
          score: 88,
          reason: "Python, ML skills align with tech focus",
        },
        leadershipPotential: {
          score: 85,
          reason: "Project leadership experience detected",
        },
      },
    },
  },
  {
    ...
    description:
      "The Fulbright Program offers grants for individually designed study/research projects or for English Teaching Assistant Programs.",
    eligibility: {
      ruleBased: {
        degree: {
          required: "Bachelor's completed",
          met: true,
          userValue: "In progress",
        },
        language: {
        ...
        researchProposal: {
          required: "Required",
          met: false,
          userValue: "Not prepared",
        },
      },
      aiBased: {
        researchExperience: {
          score: 85,
          reason: "Previous research projects detected",
        },
        academicFit: {
          score: 90,
          reason: "Strong GPA and institution reputation",
        },
        culturalExchange: {
          score: 80,
          reason: "International background and adaptability",
        },
      },
    },
  },
  {
    ...
    description:
      "PEEF provides scholarships to talented students from low-income families in Punjab, Pakistan.",
    eligibility: {
      ruleBased: {
        nationality: {
          required: "Pakistani",
        ...
        financialNeed: {
          required: "Demonstrated need",
          met: true,
          userValue: "Medium income",
        },
      ...
      aiBased: {
        ...
        academicConsistency: {
          score: 88,
          reason: "Consistent academic performance",
        },
        extracurricular: {
          score: 75,
          reason: "Moderate extracurricular involvement",
        },
      },
    },
  },
  {
    ...
    description:
      "Chevening is the UK government international awards programme aimed at developing global leaders.",
    eligibility: {
      ruleBased: {
        workExperience: {
          required: "2 years",
      ...
      aiBased: {
        leadershipQuality: {
          score: 87,
          reason: "Strong leadership indicators in profile",
        },
        careerPotential: { score: 82, reason: "Clear career trajectory" },
        networkingAbility: {
          score: 78,
          reason: "Community involvement detected",
        },
      },
    },
  },
  {
    ...
    description:
      "DAAD scholarships provide highly qualified graduates with opportunities for postgraduate studies in Germany.",
    eligibility: {
      ruleBased: {
        gpa: { required: 3.0, met: true, userValue: 3.7 },
        germanLanguage: {
      ...
      aiBased: {
        ...
        researchAlignment: {
          score: 75,
          reason: "Research interests match German institutions",
        },
        internationalMindset: {
          score: 80,
          reason: "Previous international experience",
        },
      },
    },
  },
